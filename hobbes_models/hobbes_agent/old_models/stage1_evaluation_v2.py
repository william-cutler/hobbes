...
def main():
    ...
    model = Stage1ModelV2.load_from_checkpoint("./checkpoints/v2/calvin_debug_dataset/turn_off_lightbulb/long_train/latest-epoch=2309.ckpt")
    
    # generate sample trajectory
    frames, actions = generate_trajectory(env, model, num_frames=400)

    save_gif(frames, file_name='version_2.1.gif')
